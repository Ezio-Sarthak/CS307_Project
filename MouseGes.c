...
char *prefix = "/usr/bin/";
char* forInitialProc[] = {"/usr/bin/python", "/home/ezio-sarthak/Downloads/CS307_Project/config.py", NULL};
char* command1[] = {"", NULL};
char* command2[] = {"", NULL};
char* command3[] = {"", NULL};
char* command4[] = {"", NULL};
...
static char* envp[] = {
	"SHELL=/bin/bash",
	"HOME=/home/ezio-sarthak",
    "USER=ezio_sarthak",
    "PATH=/home/ezio-sarthak/.nvm/versions/node/v14.4.0/bin:/home/ezio-sarthak/anaconda3/bin:/home/ezio-sarthak/anaconda3/condabin:/srv/zulip-py3-venv/bin:/home/ezio-sarthak/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/usr/lib/jvm/jdk1.8.0_231/bin:/usr/lib/jvm/jdk1.8.0_231/db/bin:/usr/lib/jvm/jdk1.8.0_231/jre/bin:/snap/bin:/home/ezio-sarthak/flutter_linux_1.22.3-stable/flutter/bin",
	"DISPLAY=:0",
    "PWD=/home/ezio-sarthak/Downloads/CS307_Project",
	 NULL };
...
/**
* get_min() - Get minimum value from one of the position arrays.
...
static void determinePattern(void) {
	...
	if(max_x - min_x <=2000 && abs(y_end - min_y)>2000) {
...
static int __init mouseges_init(void) {
	...
	proc_file = proc_create("mouseges_proc_file.txt", 0666, NULL, &mouseges_fops);
	if(!proc_file) {
...
static void __exit mouseges_exit(void)
{
	...
	input_unregister_device(mouseges_dev);
	input_free_device(mouseges_dev);
	remove_proc_entry("mouseges_proc_file.txt", NULL);
}
